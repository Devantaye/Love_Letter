...
Then a few days later I saw your handsome face on your close friends story hehehe. Now normally people would swipe up and say something smart or flirty, but what did I do? Clock you!! Honestly, that sums up our dynamic: I mock you, you mock back, I bully you cause you pmo, you fall in love, then I fall even harder. I never knew that one little message could spark such a beautiful romance with you, but I’m glad everything turned out the way it did. Thank you for that :’)</p>
    ...
    container.innerHTML = `
      <div class="section" id="section2">
        ...
        <p class="intro-sub">I know I’ve said this countless times but I genuinely have fallen SO HARD for you. It all started with that one call. My anxious ass hates calling with people, especially when I don’t know them like that, and yet I still answered your call. I’m glad I did tho, because we went on for HOURS rambling about ourselves and just getting to know each other. Talking with you that night felt easy. I didn’t feel like I needed to put on an act or try and win your approval. I could just be me around you, and I loved that.
Banter aside, it was nice to just talk for once with someone. Nah, it was nice just being able to talk to you 🥺
The FaceTime calls that followed warmed my heart, you don’t even understand. I’ve never used FaceTime before, everything felt so new to me, but I enjoyed it because I was with you. Being up late, talking on the phone, taking random pics of you cause you looked cute, UGHHHHH I loved every single moment of it.
...
(Also, thank you for all the sweet messages you send me. This one in particular is my favourite, and you don’t know how happy I was to wake up and read it. Tears in my eyesssss. Thank you, my love.)</p>
    ...
    container.innerHTML = `
      <div class="section" id="section5">
        ...
        <p class="intro-sub">I just want to say that I genuinely appreciate the way you love on me. Oh, how you make me fall every single time. I love the way you always check up on me and give me random little updates. You make time out of your day to talk to me, and that makes me so happy. Whenever your notifications pop up, I smile. I love the banter that we share, even when I get annoyed with you cause you loveee to piss me off, I still love it.
I find it cute when you get clingy, and when you get mad cause I annoy you too. I love that you notice even the little things. When I start to overthink or when something bugs me, you’re onto it ASAP. You never let it slide and always make sure that I’m okay.
I love that you gave me a chance. I’m always “let’s talk it out now” and you’re “let’s have some space then talk about it when we are calm,” and yet somehow we make it work. Even when it’s not your preferred way of conflict resolution, you still made the effort to try and talk it out even when you knew you were still heated. I know that wasn’t easy, but I’m glad we’ve come to a consensus on what to do, and I love that you were patient enough to talk things out with me.
Your love feels special and precious to me. You never take it for granted or treat me like you don’t love me. I feel the love in everything you say and do, and I don’t feel the need to have to beg you to love me because you already do.
You don’t just say you love me, you show that you love me. From the reassurance to the little compliments you give me to being open and honest about how you feel, I love it all. I love you. I LOVE YOU. I LOVE YOU SOO MUCHH UGHHHH !!!!</p>
    ...
    container.innerHTML = `
      <div class="section" id="section6">
        ...
        <p class="intro-sub">“Long distance is hard, but loving you is easy” is how I feel about you and our relationship. Some days I miss you so much that it physically hurts. I want to be close to you, feeling your embrace, hearing your voice, kissing you till the sun goes down. Long distance is hard, but I’m surviving it because I know that at the end of this road, I’ll be living with the love of my life, and I can’t help but smile at that thought.
When I miss you, I look back at pictures of you. The random pics you send throughout your day, the off-guard FaceTime pics I have of you, the handsome mirror selfies that you send me. They all make me so happy.
Old voice notes help with the distance too. Hearing you crash out cause I didn’t answer the phone puts a smile on my face.
Regardless of this distance tho, I can’t wait to fill up my phone with pictures of us together. When that happens, I can die happy.
It’s not easy being so far away from someone I deeply love and care about, but you’re always worth the distance. Missing you just reminds me I’ve found someone worth missing.
I can’t wait to see you, baby :’)</p>
    ...
    container.innerHTML = `
      <div class="section" id="section7">
        ...
        <p class="intro-sub">Being with you feels like taking a deep breath after holding it for too long. With you, I don’t feel like I have to explain every little thing I’m feeling, you just get it.
You’ve never made me feel like I’m “too much” or “too sensitive.” You’ve never rushed me to feel better or forced me to open up. You just stay, and that makes me feel safe.
You make me feel safe.
You let me be silly, soft, tired, sad, annoying or whatever version of me shows up, and you meet it with love. That’s something I’ve never had before.
You make me feel like I can let my guard down and still be held, still be loved. That I can drop all facades and just be me around you, the real me.
There’s something so rare about that.
You’ve become my calm, my softness and my home, and I’ll never stop being thankful for you.</p>
    ...
    container.innerHTML = `
      <div class="section" id="section8">
        ...
        <p class="intro-sub">If I died and was put into another timeline, I’d still choose you in every version of my life. I don’t want a perfect relationship, I want something that’s real. That’s what we have, together. Real, genuine love for one another.
...
I know love isn’t always easy and I know we’ll have hard days, weeks and moments that will really test us. But I’m not going anywhere.
I want to be the one who stays. Who chooses you even when things get rough and life gets heavy.
I want to be the one who fights with you, not against you. Who holds your hand through every storm of emotion and leads you to the calm.
The distance, the time and the waiting are all worth it because they lead me back to you.
I’m not just in this for now, I’m in this for every day after.
The future I want has your name written all over it, and there’s no erasing it.
No matter what comes next, my love, I’m yours.
Forever and always 🥺</p>
    ...
    container.innerHTML = `
      <div class="section end">
        ...
        <p class="intro-sub">Thank you for reading all of this. I meant every word.
Happy one month, my love!! Here’s to many more memories, laughs and late-night calls.
I love you always & forever <3 -Vante </p>
